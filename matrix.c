...
//Returns a vector from point x0 to x1
struct matrix * make_vector(double x0, double y0, double z0, double x1, double y1, double z1){
...
//Returns the cross product of two matrices with 3 elements
